...
export function ManagerOverviewPanel() {
  const trainerServices = demoServices.filter(
    (service) => service.requiresStaff,
  );
      ...
      <div className="grid gap-4 lg:grid-cols-[1.4fr_0.6fr]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Program ownership, member count, and upcoming review windows.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Services currently requiring staff assignment.
              </CardDescription>
            </CardHeader>
